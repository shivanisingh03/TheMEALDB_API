...
//                 </button><button style={{ marginTop: '-4vh', color: 'Black', width: "15vh", height: "4vh", background: 'white', marginLeft: '6vw' }}>Invoice</button>
//                 <hr
//                     style={{
//                         background: 'white',
//                         width: '92vw',
...
import './App.css';
import Home from './components/SearchAdd';
function App() {
  return (
    <div className="App">
      {/* <SearchData /> */}
